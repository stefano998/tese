...
filename=sprintf("%s_ypredEL1repon_%s_%s_0out%d_%d-%douts_%d-%ds_%ditr", alias,... 
pesos, test_stat, qtd_0out, qtt_outs_min, qtt_outs_max, min_err, max_err, qtd_itr);
save ("-ascii", filename, "y_pred");
filename=sprintf("acc_EL1repon_%s_%s_%s_0out%d_%d-%douts_%d-%ds_%d_alpha%d", pesos, alias,...
test_stat, qtd_0out, qtt_outs_min, qtt_outs_max, min_err, max_err, qtd_itr, alpha*100);
save ("-ascii", filename, "acc");
filename=sprintf("acc_por_obs_EL1repon_%s_%s_%s_0out%d_%d-%douts_%d-%ds_%d_alpha%d", pesos, alias,...
test_stat, qtd_0out, qtt_outs_min, qtt_outs_max, min_err, max_err, qtd_itr, alpha*100);
