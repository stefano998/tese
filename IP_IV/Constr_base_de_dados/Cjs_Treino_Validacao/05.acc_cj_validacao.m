...
filename=sprintf("VC_%s_%s_%s_%d", method, pesos, alias, 200000);
VCAll=importdata(filename);
alpha=VCAll(8,1)

filename=sprintf("%s_ypred%s_%s_%d-%douts_%d-%ds_%ditr_train", alias, method,... 
...
filename=sprintf("acc_VAL_%s_%s_%s_%d-%douts_%d-%ds_%d_alpha%d", method, pesos, alias,...
